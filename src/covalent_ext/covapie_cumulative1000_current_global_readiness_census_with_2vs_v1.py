"""Additive cumulative1000 readiness census refresh for published 2VS Exact8.

This successor consumes the frozen PRF-refreshed census plus already-published
2VS ingestion and reconciliation authority.  It deep-copies the predecessor
rows and overlays only 2VS Exact8.  It creates no human, chemistry, pair, role,
...
from . import covapie_completed_human_decision_reconciliation_with_2vs_v1 as two_vs_reconciliation
from . import covapie_cumulative1000_current_global_readiness_census_with_prf_v1 as predecessor
from . import covapie_2vs_completed_decision_ingestion_and_task_label_availability_v1 as two_vs_ingestion


__all__ = (
    "Cumulative1000CurrentGlobalReadinessCensusWith2VSError",
    "compute_covapie_cumulative1000_current_global_readiness_census_with_2vs_v1",
    "validate_covapie_cumulative1000_current_global_readiness_census_with_2vs_v1",
    "build_covapie_cumulative1000_current_global_readiness_artifacts_with_2vs_v1",
    "materialize_covapie_cumulative1000_current_global_readiness_artifacts_with_2vs_v1",
)


SCHEMA_VERSION = "covapie_cumulative1000_current_global_readiness_census_with_2vs_v1"
STAGE = "COVAPIE_CUMULATIVE1000_CURRENT_GLOBAL_READINESS_CENSUS_WITH_2VS_V1"
ERROR_TOKEN = "COVAPIE_CUMULATIVE1000_CURRENT_GLOBAL_READINESS_CENSUS_WITH_2VS_V1_ERROR"

OUTPUT_DIRECTORY_RELATIVE = Path(
    "data/derived/covalent_small/"
    "covapie_cumulative1000_current_global_readiness_census_with_2vs_v1"
)
CENSUS_FILE = "covapie_cumulative1000_current_global_readiness_census_with_2vs_v1.csv"
SUMMARY_FILE = "covapie_cumulative1000_current_global_readiness_summary_with_2vs_v1.json"
MANIFEST_FILE = "covapie_cumulative1000_current_global_readiness_manifest_with_2vs_v1.json"
...
CHECKER_RELATIVE = Path(
    "scripts/check_covapie_cumulative1000_current_global_readiness_census_with_2vs_v1.py"
)
TEST_RELATIVE = Path(
    "tests/test_covapie_cumulative1000_current_global_readiness_census_with_2vs_v1.py"
)
GUIDE_RELATIVE = Path(
    "docs/covapie_cumulative1000_current_global_readiness_census_with_2vs_v1_guide.md"
)
...
base = predecessor.predecessor.predecessor
TWO_VS_EXACT8_EVENT_IDS_V1 = two_vs_ingestion.EXPECTED_EVENT_IDS
TWO_VS_EXACT8_RANKS_V1 = two_vs_ingestion.EXPECTED_RANKS
TWO_VS_REVIEW_UNIT_ID_V1 = two_vs_ingestion.EXPECTED_REVIEW_UNIT_ID
TWO_VS_DIRECT_TASK_IDS_CELL_V1 = "[0,3,4]"
...
TWO_VS_RECONCILIATION_OWNER_RELATIVE = Path(
    "src/covalent_ext/covapie_completed_human_decision_reconciliation_with_2vs_v1.py"
)
TWO_VS_INGESTION_OWNER_RELATIVE = two_vs_ingestion.SOURCE_RELATIVE
TWO_VS_EVENT_MATRIX_RELATIVE = two_vs_ingestion.OUTPUT_ROOT_RELATIVE / two_vs_ingestion.MATRIX
TWO_VS_FORMAL_DECISION_RELATIVE_TO_REPOSITORY_PARENT = (
    two_vs_ingestion.FORMAL_DECISION_RELATIVE_TO_REPOSITORY_PARENT
)
PRIORITY_QUEUE_RELATIVE = predecessor.PRIORITY_QUEUE_RELATIVE

TWO_VS_EVENT_MATRIX_SOURCE = TWO_VS_EVENT_MATRIX_RELATIVE.as_posix()
TWO_VS_FORMAL_DECISION_SOURCE = (
    TWO_VS_FORMAL_DECISION_RELATIVE_TO_REPOSITORY_PARENT.as_posix()
)

_EXPECTED_GLOBAL_STATUS_COUNTS_V1 = {
    generic.CURRENTLY_UNREVIEWED: 257,
    generic.CURRENTLY_IN_PROGRESS: 0,
    generic.COMPLETED_HUMAN_POSITIVE: 57,
...
_EXPECTED_BOOLEAN_COUNTS_V1.update(
    {
        "reactive_pair_sample_authoritative": 74,
        "role_partition_sample_authoritative": 74,
        "canonical_mask_structural_labels_available": 74,
    }
)
...
_EXPECTED_REFRESHED_SEMANTIC_SOURCE_BINDINGS_SHA256_V1 = (
    "77e22e96e118d4ebc7b468daee89694d37c4aa0a51f63ae937e4498d82724b59"
)

_SHA_PATTERN = re.compile(r"^[0-9a-f]{64}$")
_STRUCTURAL_IDENTITY_FIELDS_V1 = predecessor._STRUCTURAL_IDENTITY_FIELDS_V1
_AUTHORIZED_TWO_VS_OVERLAY_FIELDS_V1 = predecessor._AUTHORIZED_PRF_OVERLAY_FIELDS_V1
_EXPECTED_TWO_VS_STRUCTURAL_CELLS_V1 = {
...
_ADDITIVE_SOURCE_SPECS_V1 = (
    ("PREDECESSOR_PRF_CENSUS_OWNER", PREDECESSOR_OWNER_RELATIVE, "repository_relative", 53480, "11c8fcadaa7fb25247de012ff5c9cb984006221969808dddfc87ba867286ad6f"),
    ("PREDECESSOR_PRF_MATERIALIZED_CENSUS", PREDECESSOR_CENSUS_RELATIVE, "repository_relative", 506220, "a707cb60c8f788f9ad0e94e89c4038226cfa5f94c15b0afcfa6e36adca3c1b12"),
    ("PREDECESSOR_PRF_MATERIALIZED_SUMMARY", PREDECESSOR_SUMMARY_RELATIVE, "repository_relative", 14742, "82d4d36beb21efb2a588beaea9d3b9c61a6275596482e39ff45341e4cbe316f7"),
    ("TWO_VS_RECONCILIATION_SUCCESSOR", TWO_VS_RECONCILIATION_OWNER_RELATIVE, "repository_relative", 11923, "e4ffb8300f40e3883560605cbf485481a42adc9321c7d602104c7467ad3df4f7"),
    ("TWO_VS_INGESTION_OWNER", TWO_VS_INGESTION_OWNER_RELATIVE, "repository_relative", 79775, "8812b4f9d0c77af4228b6f71ec9183867fec778311b290f8362a1164081e1409"),
    ("TWO_VS_EVENT_TASK_LABEL_AVAILABILITY", TWO_VS_EVENT_MATRIX_RELATIVE, "repository_relative", 13276, "b5c08fecbd5a68408cea6b7ce4747734f3d6c3ea37d81aef939a634d6439c5cc"),
    ("TWO_VS_FORMAL_HUMAN_DECISION", TWO_VS_FORMAL_DECISION_RELATIVE_TO_REPOSITORY_PARENT, "repository_parent_relative", 28640, "49f33bb2a21669ddb7ab8e98cfa710380e031b280855d5f3ebe6796cde2d06aa"),
)


class Cumulative1000CurrentGlobalReadinessCensusWith2VSError(ValueError):
    """Raised unless the additive 2VS refresh is exactly source-derived."""


def _fail(reason: str) -> NoReturn:
    raise Cumulative1000CurrentGlobalReadinessCensusWith2VSError(
...
def _load_and_validate_two_vs_event_matrix_v1(root: Path) -> tuple[dict[str, str], ...]:
    payload = _read_regular_file(root / TWO_VS_EVENT_MATRIX_RELATIVE, "TWO_VS_EVENT_MATRIX")
    if len(payload) != 13276 or _sha256(payload) != _ADDITIVE_SOURCE_SPECS_V1[5][4]:
        _fail("TWO_VS_EVENT_MATRIX_BINDING_INVALID")
    source_derived = two_vs_ingestion.build_artifacts_v1(root)
    if source_derived[two_vs_ingestion.MATRIX] != payload:
        _fail("TWO_VS_EVENT_MATRIX_NOT_SOURCE_DERIVED")
    try:
        reader = csv.DictReader(io.StringIO(payload.decode("utf-8"), newline=""))
    except UnicodeDecodeError as error:
        raise Cumulative1000CurrentGlobalReadinessCensusWith2VSError(
            f"{ERROR_TOKEN}:TWO_VS_EVENT_MATRIX_NOT_UTF8"
        ) from error
    if tuple(reader.fieldnames or ()) != two_vs_ingestion.MATRIX_HEADER:
        _fail("TWO_VS_EVENT_MATRIX_HEADER_INVALID")
    rows = tuple(dict(row) for row in reader)
    if (
        len(rows) != 8
        or tuple(row["canonical_event_id"] for row in rows) != TWO_VS_EXACT8_EVENT_IDS_V1
        or tuple(int(row["scaleup_rank"]) for row in rows) != TWO_VS_EXACT8_RANKS_V1
        or len({row["canonical_event_id"] for row in rows}) != 8
    ):
        _fail("TWO_VS_EVENT_MATRIX_IDENTITY_NOT_EXACT8")
    expected_cells = {
        ...
        "direct_profile_applicable_task_ids_json": TWO_VS_DIRECT_TASK_IDS_CELL_V1,
        ...
        "authority_source": two_vs_ingestion.AUTHORITY_SOURCE,
    ...
    for row in rows:
        ...
        if any(row[key] != value for key, value in expected_cells.items()):
            _fail("TWO_VS_EVENT_MATRIX_SEMANTICS_INVALID:" + event_id)
        try:
            applicability = json.loads(row["canonical_task_applicability_json"])
        except json.JSONDecodeError as error:
            raise Cumulative1000CurrentGlobalReadinessCensusWith2VSError(
                f"{ERROR_TOKEN}:TWO_VS_EXACT5_JSON_INVALID:{event_id}"
            ) from error
        if (
            len(applicability) != 5
            ...
            _fail("TWO_VS_EVENT_MATRIX_EXACT5_INVALID:" + event_id)
    return rows


def _validate_two_vs_reconciliation_v1(root: Path) -> generic.ReconciliationResult:
    result = two_vs_reconciliation.reconcile_real_completed_human_decisions_with_2vs_v1(root)
    if result.review_summary != {
        ...
        _fail("TWO_VS_RECONCILIATION_SUMMARY_INVALID")
    if len(result.normalized_facts) != 57 or Counter(
        fact.training_disposition for fact in result.normalized_facts
    ) != Counter({generic.TRAINING_INCLUDE: 12, generic.TRAINING_EXCLUDE: 45}):
        _fail("TWO_VS_RECONCILIATION_NORMALIZED_FACTS_INVALID")
    rows = [
        row for row in result.reconciled_rows
        if row["raw_review_unit_id"] == TWO_VS_REVIEW_UNIT_ID_V1
    ]
    if (
        len(rows) != 8
        or {row["canonical_event_id"] for row in rows} != set(TWO_VS_EXACT8_EVENT_IDS_V1)
        or any(row["current_review_status"] != generic.COMPLETED_HUMAN_POSITIVE for row in rows)
    ):
        _fail("TWO_VS_RECONCILIATION_EXACT8_INVALID")
    return result


def _assert_predecessor_two_vs_state_v1(
    computation: base.Cumulative1000CurrentGlobalReadinessComputationV1,
) -> None:
    rows = [
        row for row in computation.rows
        if row["canonical_event_id"] in set(TWO_VS_EXACT8_EVENT_IDS_V1)
    ]
    if len(rows) != 8 or tuple(int(row["scaleup_rank"]) for row in rows) != TWO_VS_EXACT8_RANKS_V1:
        _fail("PREDECESSOR_TWO_VS_EXACT8_IDENTITY_INVALID")
    expected = {
        "current_global_status": generic.CURRENTLY_UNREVIEWED,
        "priority_review_in_scope": "true",
        "review_unit_id": TWO_VS_REVIEW_UNIT_ID_V1,
    ...
    if any(any(row[key] != value for key, value in expected.items()) for row in rows):
        _fail("PREDECESSOR_TWO_VS_STATE_INVALID")
    if any(
        any(row[field] != value for field, value in _EXPECTED_TWO_VS_STRUCTURAL_CELLS_V1.items())
        for row in rows
    ):
        _fail("PREDECESSOR_TWO_VS_STRUCTURAL_COVERAGE_INVALID")
    if Counter(row["chemistry_disposition"] for row in computation.rows)[
        base.CHEMISTRY_POSITIVE
    ] != 66:
        _fail("PREDECESSOR_POSITIVE_COUNT_NOT_66")


def _overlay_two_vs_exact8_v1(
    ...
    if set(matrix_by_event) != set(TWO_VS_EXACT8_EVENT_IDS_V1) or len(matrix_by_event) != 8:
        _fail("TWO_VS_OVERLAY_MATRIX_SET_INVALID")
    ...
    for row in rows:
        ...
        if (
            ...
            or row["ligand_component_id"] != "2VS"
            or row["review_unit_id"] != TWO_VS_REVIEW_UNIT_ID_V1
        ):
            _fail("TWO_VS_MATRIX_PREDECESSOR_IDENTITY_MISMATCH:" + event_id)
        row.update(
            {
                "current_global_status": generic.COMPLETED_HUMAN_POSITIVE,
                "current_review_status": generic.COMPLETED_HUMAN_POSITIVE,
                "human_review_completed": "true",
                "human_review_authority_source": TWO_VS_FORMAL_DECISION_SOURCE,
                "chemistry_disposition": base.CHEMISTRY_POSITIVE,
                "chemistry_authority_source": TWO_VS_EVENT_MATRIX_SOURCE,
                "task_relevance_disposition": base.TASK_RELEVANT,
                "task_relevance_authority_source": TWO_VS_EVENT_MATRIX_SOURCE,
                ...
                "structurally_applicable_task_ids_json": TWO_VS_DIRECT_TASK_IDS_CELL_V1,
                "post_geometry_sample_authoritative": "false",
                "post_geometry_training_target_available": "false",
                "pre_geometry_authoritative": "false",
                "pre_geometry_training_target_available": "false",
                ...
                "positive_authority_source": TWO_VS_EVENT_MATRIX_SOURCE,
...
def _build_summary_v1(
    ...
    summary["refresh_delta"] = {
        "frozen_predecessor_positive_count": 66,
        "two_vs_exact8_delta_count": 8,
    ...
    summary["chemistry"] = {
        ...
        "positive_source_composition": {
            ...
            "ONL": sum(row["positive_authority_source"] == predecessor.predecessor.ONL_EVENT_MATRIX_SOURCE for row in rows),
            "PRF": sum(row["positive_authority_source"] == predecessor.PRF_EVENT_MATRIX_SOURCE for row in rows),
            "2VS": sum(row["positive_authority_source"] == TWO_VS_EVENT_MATRIX_SOURCE for row in rows),
        },
    ...
    summary["training_stage"]["future_candidate_source_composition"] = {
        "FFQ": 4, "POA": 8, "G3H": 0, "ONL": 0, "PRF": 0, "2VS": 0
    }
    summary["blockers"] = {
        ...
        "pair_authority_absent": {
            ...
            "within_positive_74": sum(row["reactive_pair_sample_authoritative"] == "false" for row in positive_rows),
        },
        "role_authority_absent": {
            "all_1000": sum(row["role_partition_sample_authoritative"] == "false" for row in rows),
            "within_positive_74": sum(row["role_partition_sample_authoritative"] == "false" for row in positive_rows),
        },
        "human_training_exclusion": {"within_positive_74": sum(row["human_training_excluded"] == "true" for row in positive_rows)},
        "missing_split_authority": {
            "within_positive_74": sum(row["formal_split_authoritative"] == "false" for row in positive_rows),
            "within_include_29": sum(row["formal_split_authoritative"] == "false" for row in include_rows),
        },
        "missing_tensor_integration": {
            "within_positive_74": len(missing_tensor_rows),
            ...
            "missing_source_composition": {
                ...
                "ONL": sum(row["positive_authority_source"] == predecessor.predecessor.ONL_EVENT_MATRIX_SOURCE for row in missing_tensor_rows),
                "PRF": sum(row["positive_authority_source"] == predecessor.PRF_EVENT_MATRIX_SOURCE for row in missing_tensor_rows),
                "2VS": sum(row["positive_authority_source"] == TWO_VS_EVENT_MATRIX_SOURCE for row in missing_tensor_rows),
            },
        },
        "missing_POST_training_authority": {
            "within_positive_74": sum(row["post_geometry_training_target_available"] == "false" for row in positive_rows),
        ...
        "missing_training_admission": {
            "within_positive_74": sum(row["formal_training_admitted"] == "false" for row in positive_rows),
            "within_include_29": sum(row["formal_training_admitted"] == "false" for row in include_rows),
        },
        "feature_semantics_pending": {"within_positive_74": len(positive_rows)},
    }
    summary["top_pending_review_units_by_event_yield"] = top_pending
    summary["authority_boundary"].update(
        {
            "next_priority_review_unit": "COVAPIE_BULK_REVIEW_UNIT_9723B0F9EC07CC81",
            "next_priority_review_ligand": "1F8",
...
def compute_covapie_cumulative1000_current_global_readiness_census_with_2vs_v1(
    repo_root: Path,
) -> base.Cumulative1000CurrentGlobalReadinessComputationV1:
    """Compute the exact additive 2VS refresh entirely from frozen sources."""

    root = repo_root.resolve()
    additive_bindings = _verify_additive_sources(root)
    frozen = predecessor.compute_covapie_cumulative1000_current_global_readiness_census_with_prf_v1(root)
    _assert_predecessor_two_vs_state_v1(frozen)
    reconciliation = _validate_two_vs_reconciliation_v1(root)
    matrix_rows = _load_and_validate_two_vs_event_matrix_v1(root)
    rows = _overlay_two_vs_exact8_v1(frozen.rows, matrix_rows)
...
def validate_covapie_cumulative1000_current_global_readiness_census_with_2vs_v1(
    computation: object,
    *,
    ...
    frozen = predecessor.compute_covapie_cumulative1000_current_global_readiness_census_with_prf_v1(root) if predecessor_computation is None else predecessor_computation
    ...
    two_vs_set = set(TWO_VS_EXACT8_EVENT_IDS_V1)
    if changed != two_vs_set or len(changed) != 8:
        _fail("PREDECESSOR_DELTA_NOT_EXACT_TWO_VS8")
    if any(refreshed_by_event[event_id] != frozen_by_event[event_id] for event_id in seen - two_vs_set):
        _fail("NON_TWO_VS_ROW_CHANGED")
    ...
    for event_id in TWO_VS_EXACT8_EVENT_IDS_V1:
        ...
        if changed_fields != expected_changed_fields or not changed_fields <= _AUTHORIZED_TWO_VS_OVERLAY_FIELDS_V1:
            _fail("TWO_VS_CHANGED_FIELD_SET_INVALID:" + event_id)
        if any(before[field] != after[field] for field in _STRUCTURAL_IDENTITY_FIELDS_V1):
            _fail("TWO_VS_STRUCTURAL_EVIDENCE_CHANGED:" + event_id)
        if any(after[field] != value for field, value in expected_two_vs.items()):
            _fail("TWO_VS_REFRESHED_SEMANTICS_INVALID:" + event_id)

    previous_sets = _sets_for_algebra_v1(frozen.rows)
    current_sets = _sets_for_algebra_v1(rows)
    if previous_sets["chemistry_positive"] & two_vs_set:
        _fail("TWO_VS_PREDECESSOR_POSITIVE_INTERSECTION_NOT_EMPTY")
    if not (
        current_sets["chemistry_positive"] == previous_sets["chemistry_positive"] | two_vs_set
        and current_sets["chemistry_unresolved"] == previous_sets["chemistry_unresolved"] - two_vs_set
        and current_sets["task_relevant"] == previous_sets["task_relevant"] | two_vs_set
        and current_sets["task_unresolved"] == previous_sets["task_unresolved"] - two_vs_set
        and current_sets["training_exclude"] == previous_sets["training_exclude"] | two_vs_set
        and current_sets["training_unresolved"] == previous_sets["training_unresolved"] - two_vs_set
        ...
        _fail("TWO_VS_EXACT_SET_ALGEBRA_INVALID")

    if Counter(row["chemistry_disposition"] for row in rows) != Counter({"POSITIVE": 74, "NOT_ESTABLISHED": 86, "UNRESOLVED": 840}):
        _fail("CENSUS_CHEMISTRY_DISTRIBUTION_INVALID")
    if Counter(row["task_relevance_disposition"] for row in rows) != Counter({"RELEVANT": 75, "NOT_RELEVANT": 86, "UNRESOLVED": 839}):
        _fail("CENSUS_TASK_DISTRIBUTION_INVALID")
    if Counter(row["training_use_disposition"] for row in rows) != Counter({"INCLUDE": 29, "EXCLUDE_FROM_TRAINING_ONLY": 45, "NOT_APPLICABLE": 86, "UNRESOLVED": 840}):
    ...
    if Counter(row["role_profile"] for row in rows if row["role_partition_sample_authoritative"] == "true") != Counter({base.STRICT_PROFILE: 31, base.DIRECT_PROFILE: 43}):
...
def build_covapie_cumulative1000_current_global_readiness_artifacts_with_2vs_v1(
    repo_root: Path,
) -> dict[str, bytes]:
    """Build the deterministic Exact3 outputs without repository writes."""

    root = repo_root.resolve()
    computation = compute_covapie_cumulative1000_current_global_readiness_census_with_2vs_v1(root)
...
def materialize_covapie_cumulative1000_current_global_readiness_artifacts_with_2vs_v1(
    repo_root: Path,
    ...
    artifacts = build_covapie_cumulative1000_current_global_readiness_artifacts_with_2vs_v1(root)
