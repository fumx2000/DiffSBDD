...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| BTK_C481_6DI9_pre_reaction | BTK_C481_6DI9 | true | true | true | true | true | training_dataset_design_review_qa_passed | false | false | prepare_training_dataset_packaging_design_gate_not_training |
| KRAS_G12C_5F2E_pre_reaction | KRAS_G12C_5F2E | true | true | true | true | true | training_dataset_design_review_qa_passed | false | false | prepare_training_dataset_packaging_design_gate_not_training |
| KRAS_G12C_6OIM_pre_reaction | KRAS_G12C_6OIM | true | true | true | true | true | training_dataset_design_review_qa_passed | false | false | prepare_training_dataset_packaging_design_gate_not_training |

## Global Conclusion

- all three samples passed training dataset design review QA
...
- no training was run
- next step is training dataset packaging design gate, not training
