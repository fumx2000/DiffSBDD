...
from covalent_ext import real_covalent_confirmed_candidate_pocket_extraction_design_gate as gate  # noqa: E402
        ...
        rows.append(
            {
                ...
                "decision": "pocket extraction design accepted" if passed else "pocket extraction design blocked",
...
def write_summary(manifest: dict[str, Any], path: str | Path) -> None:
    ...
    text = f"""# Real Covalent Confirmed Candidate Pocket Extraction Design Gate v0 Summary
...
This step inherited {manifest["protein_full_atom_table_row_count"]} protein atom rows, {manifest["ligand_full_atom_table_row_count"]} ligand atom rows, and {manifest["endpoint_recovery_audit_row_count"]} endpoint audit rows.
...
def run() -> int:
    result = gate.build_real_covalent_confirmed_candidate_pocket_extraction_design_gate_v0()
    ...
    print(
        "real_covalent_confirmed_candidate_pocket_extraction_design_gate_v0_"
