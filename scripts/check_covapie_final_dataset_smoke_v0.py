...
from covalent_ext import covapie_final_dataset_smoke as legacy  # noqa: E402
...
def run() -> int:
    ...
    successor_manifest_path_contract_passed = (
        stage_policy.superseded_by_manifest_path == EXPECTED_SUCCESSOR_MANIFEST
    )
    values = {
    ...
    print(
        "covapie_final_dataset_smoke_v0_retirement_policy_passed"
        if passed
        else "covapie_final_dataset_smoke_v0_retirement_policy_blocked"
    )
