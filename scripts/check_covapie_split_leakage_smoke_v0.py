...
from covalent_ext import covapie_split_leakage_smoke as legacy  # noqa: E402
...
def run() -> int:
    ...
    print(
        "covapie_split_leakage_smoke_v0_retirement_policy_passed"
        if passed
        else "covapie_split_leakage_smoke_v0_retirement_policy_blocked"
    )
