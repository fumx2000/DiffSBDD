...
from covalent_ext import covapie_dataloader_interface_qa_gate as legacy  # noqa: E402
...
def run() -> int:
    ...
    print(
        "covapie_dataloader_interface_qa_gate_v0_retirement_policy_passed"
        if passed
        else "covapie_dataloader_interface_qa_gate_v0_retirement_policy_blocked"
    )
