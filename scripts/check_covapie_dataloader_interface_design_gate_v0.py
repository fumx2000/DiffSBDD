...
from covalent_ext import covapie_dataloader_interface_design_gate as legacy  # noqa: E402
...
def run() -> int:
    ...
    redesign_pending = (
        stage_policy.successor_availability == "redesign_pending"
        and stage_policy.superseded_by_stage is None
        and stage_policy.superseded_by_manifest_path is None
        and "dataloader_interface_redesign_pending"
        in stage_policy.blocking_reasons
    )
    values = {
        ...
        "successor_stage_is_none": stage_policy.superseded_by_stage is None,
        ...
        "dataloader_interface_redesign_pending": redesign_pending,
    ...
    passed = (
        ...
        and stage_policy.superseded_by_stage is None
        and stage_policy.successor_availability == "redesign_pending"
        and stage_policy.superseded_by_manifest_path is None
        and redesign_pending is True
        ...
        and stage_policy.blocking_reasons == EXPECTED_BLOCKERS
    )
    print(
        "covapie_dataloader_interface_design_gate_v0_retirement_policy_passed"
        if passed
        else "covapie_dataloader_interface_design_gate_v0_retirement_policy_blocked"
    )
