#!/usr/bin/env python3
"""Checker-owned semantic verification for the ADMIT_006 adapter design gate."""
...
MODULE_NAME = "covalent_ext.covapie_bulk_download_admission_admit_006_unified_adapter_contract_design_gate"
OUTPUT_ROOT = ROOT / "data/derived/covalent_small/covapie_bulk_download_admission_admit_006_unified_adapter_contract_design_gate_v1"
EXPECTED_BASE = "b26a7eb2e3856bd0993ce4a797afa0d46c514a25"
EXPECTED_SUBJECT = "add CovaPIE standalone ADMIT_006 rule logic interface v1"
RULE_ID = "ADMIT_006"
RULE_NAME = "explicit_covalent_event_evidence"
ADAPTER_ID = "covapie_admit_006_unified_adapter_v1"
FORMAL_EVALUATOR = "evaluate_admit_006"
FORMAL_SOURCE = "src/covalent_ext/covapie_bulk_download_admission_admit_006_rule_logic_interface.py"
ORACLE_ID = "classify_admit_006_admit_007_evidence_design"
SCHEMA = "covapie_unified_admission_rule_evaluation_v1"
NEXT_STEP = "implement_covapie_unified_dispatch_runtime_with_admit_001_to_006_v1"
FUTURE_ORDER = tuple(f"ADMIT_{index:03d}" for index in range(1, 7))
CURRENT_ORDER = FUTURE_ORDER[:5]
...
CANDIDATE_REASON = "ADMIT_006_CANDIDATE_RECORD_MAPPING_INVALID"
...
OUTPUTS = (
    "covapie_admit_006_unified_adapter_contract.csv",
    "covapie_admit_006_candidate_projection_and_context_routing_matrix.csv",
    "covapie_admit_006_unified_result_projection_truth_matrix.csv",
    "covapie_admit_006_unified_adapter_safety_audit.csv",
    "covapie_admit_006_unified_adapter_issue_readiness_inventory.csv",
    "covapie_admit_006_unified_adapter_contract_manifest.json",
)
FROZEN_OUTPUT_SHA256 = {
    OUTPUTS[0]: "2aee305dc9eece0631a3fe11791b78389639de8f1d573bee185a5046c95ae242",
    OUTPUTS[1]: "c43b1d1e071607a1040f5d66398164acad5eb01c6873aae32c95bf2796f08fab",
    OUTPUTS[2]: "c50fa504c6c569127e901f6256fd064b1dc7f773ea92c308279261dcfb9ae7c0",
    OUTPUTS[3]: "e34297ac8d8a8e8b841ed1e1ccd0d0783c3f5b755976cfa21a15af3f31797539",
    OUTPUTS[4]: "d3333fd74af79b065eb136d830e730c3a636e0d632bcb735b3e841a29d548c79",
    OUTPUTS[5]: "449f3f2f5bcf7b7e6a2d60504238da91f41f67822a9747e32fd6eb60b88468b2",
}
SOURCE_BOUNDARY = (
    (FORMAL_SOURCE, "6fd3727234b4b3f637fa5812c78421ec944238518702bc7f9d0d57a654d9a46d"),
    ...
    ("data/derived/covalent_small/covapie_bulk_download_admission_admit_006_rule_logic_interface_v1/covapie_admit_006_rule_logic_interface_contract.csv", "b19c251567e2d1b56d425e6dbcdca1a77c7238c026b7786b00ade429682ab792"),
    ("data/derived/covalent_small/covapie_bulk_download_admission_admit_006_rule_logic_interface_v1/covapie_admit_006_rule_logic_interface_truth_matrix.csv", "793d754f81a54bb785e74665893651e02c5bb12d01d877d43ff3007cc2fc8b02"),
    ("data/derived/covalent_small/covapie_bulk_download_admission_admit_006_rule_logic_interface_v1/covapie_admit_006_rule_logic_interface_issue_readiness_inventory.csv", "d3333fd74af79b065eb136d830e730c3a636e0d632bcb735b3e841a29d548c79"),
    ...
    ("data/derived/covalent_small/covapie_bulk_download_admission_unified_dispatch_runtime_with_admit_001_to_005_v1/covapie_admit_001_to_005_runtime_manifest.json", "699143ca47d8ff51dbf9779fce2a95ef537d1d6053d93a73f941725d6219256e"),
    ("src/covalent_ext/covapie_bulk_download_admission_admit_005_unified_adapter_contract_design_gate.py", "078987fdcb51d91ec8fa229884a85c2cc75f8b05ef1249aaf392893f6cc1b4ad"),
)
READINESS_TRUE = (
    "admit_006_standalone_evaluator_available",
    "admit_006_candidate_projection_contract_frozen",
    "admit_006_context_routing_contract_frozen",
    "admit_006_missing_field_value_contract_frozen",
    "admit_006_unified_adapter_contract_frozen",
    "admit_006_source_result_validation_contract_frozen",
    "admit_006_source_oracle_equivalence_contract_frozen",
    "admit_006_unified_result_projection_contract_frozen",
    "admit_006_blocked_passthrough_contract_frozen",
    "admit_006_context_invalid_partial_canonical_projection_frozen",
    "ready_for_unified_dispatch_runtime_with_admit_001_to_006_implementation",
    "feature_semantics_audit_required_before_training",
)
READINESS_FALSE = (
    "admit_006_unified_adapter_implemented", "admit_006_registered_in_engine",
    "current_exact5_runtime_modified", "admit_007_standalone_evaluator_implemented",
    "admit_007_unified_adapter_contract_frozen", "admit_007_unified_adapter_implemented",
    "admit_007_registered_in_engine", "admit_007_to_015_registered_in_engine",
...
STANDALONE_COLUMNS = ("case_id", "case_group", "scalar_input_kind", "scalar_input_display", "context_input_kind", "context_input_display", "expected_outcome", "expected_reason", "observed_outcome", "observed_reason", "expected_canonical_evidence_source", "observed_canonical_evidence_source", "expected_validated_candidate_fields", "observed_validated_candidate_fields", "consumed_candidate_fields", "consumed_context_items", "evaluator_io_used", "case_passed")
...
def _expected_contract_rows() -> list[dict[str, str]]:
    definitions = (
        ...
        ("registration", "future_exact6_order", "|".join(FUTURE_ORDER)),
        ("registration", "current_exact5_order", "|".join(CURRENT_ORDER)),
...
def _assert_ast_independence(source_text: str | None = None) -> None:
    ...
    forbidden_attributes = {
        ...
        "build_design_state", "classify_admit_006_independent_design",
...
def _validate_issue_rows(header: Sequence[str], rows: Sequence[Mapping[str, str]], content: bytes) -> None:
    predecessor = ROOT / SOURCE_BOUNDARY[4][0]
    ...
    if issues["UNIFIED_ADMISSION_RULE_COVERAGE_INCOMPLETE"]["status"] != "open" or "ADMIT_006" not in issues["UNIFIED_ADMISSION_RULE_COVERAGE_INCOMPLETE"]["affected_rules"].split("|"):
...
def _validate_manifest(manifest: Mapping[str, Any]) -> None:
    ...
    exact = {
        "project": "CovaPIE", "step": "ADMIT_006 unified adapter contract design gate v1",
        ...
        "formal_evaluator": FORMAL_EVALUATOR, "formal_evaluator_source": FORMAL_SOURCE,
        "independent_oracle": ORACLE_ID, "future_registered_rule_order": list(FUTURE_ORDER),
        ...
        "source_input_count": 13, "source_input_paths": [path for path, _ in SOURCE_BOUNDARY],
        ...
        "output_sha256_excludes_manifest_self_hash": True, "readiness": readiness,
        "all_checks_passed": True,
    }
    for key, value in exact.items():
        if manifest.get(key) != value:
            raise AssertionError(f"manifest field mismatch: {key}")
    for key, value in readiness.items():
        if manifest.get(key) is not value:
            raise AssertionError(f"manifest readiness overclaim/mismatch: {key}")
...
def _validate_output_tree(root: Path, *, enforce_frozen_hashes: bool = True,
    ...
    standalone_header, standalone_rows = _read_csv_document(ROOT / SOURCE_BOUNDARY[3][0])
    ...
    return {"contract_rows": 43, "routing_rows": 23, "truth_rows": 56,
            "safety_rows": 41, "issue_rows": 11, "source_count": 13}


def _assert_production_ast() -> None:
    path = ROOT / "src/covalent_ext/covapie_bulk_download_admission_admit_006_unified_adapter_contract_design_gate.py"
    tree = ast.parse(path.read_text(encoding="utf-8"))
    functions = {node.name for node in tree.body if isinstance(node, ast.FunctionDef)}
    if "_evaluate_registered_admit_006" in functions or "evaluate_admission_rule" in functions:
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory() as first, tempfile.TemporaryDirectory() as second:
        ...
        production.run_covapie_bulk_download_admission_admit_006_unified_adapter_contract_design_gate_v1(first_root)
        production.run_covapie_bulk_download_admission_admit_006_unified_adapter_contract_design_gate_v1(second_root)
        for name in OUTPUTS:
    ...
    summary.update({"all_checks_passed": True, "output_file_count": 6,
                    "readiness": "ready_for_unified_dispatch_runtime_with_admit_001_to_006_implementation"})
