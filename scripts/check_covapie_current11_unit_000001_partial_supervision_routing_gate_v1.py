#!/usr/bin/env python3
"""Check the Current11 unit-1 task-level partial-supervision routing gate."""
...
from covalent_ext.covapie_current11_unit_000001_partial_supervision_routing_gate_v1 import (  # noqa: E402
    ERROR_TOKEN,
