#!/usr/bin/env python3
"""Independent fail-closed checker for the ADMIT_001-to-006 runtime."""
...
from covalent_ext import (  # noqa: E402
    covapie_bulk_download_admission_unified_dispatch_runtime_with_admit_001_to_006
    as runtime,
)


CHECKER_EXPECTED_BASE_COMMIT = "de5b9ef13068201d245a5e7231e2b35e44e07d95"
CHECKER_EXPECTED_BASE_SUBJECT = (
    "add CovaPIE ADMIT_006 unified adapter contract design v1"
)
CHECKER_PROJECT = "CovaPIE"
CHECKER_STEP = "unified dispatch runtime with ADMIT_001 to ADMIT_006 v1"
CHECKER_STAGE = (
...
CHECKER_SOURCE_BOUNDARY = (
    (
        Path("src/covalent_ext/covapie_bulk_download_admission_unified_dispatch_runtime_with_admit_001_to_005.py"),
        "c923d0dfe2edad534a2f530dbbac53870823ff2aa231730acbcd63577edfdb23",
    ),
    (
        Path("data/derived/covalent_small/covapie_bulk_download_admission_unified_dispatch_runtime_with_admit_001_to_005_v1/covapie_admit_001_to_005_runtime_manifest.json"),
        "699143ca47d8ff51dbf9779fce2a95ef537d1d6053d93a73f941725d6219256e",
    ),
    (
        Path("data/derived/covalent_small/covapie_bulk_download_admission_unified_dispatch_runtime_with_admit_001_to_005_v1/covapie_admit_001_to_005_runtime_contract.csv"),
        "36c43797e622177d70a0b206d50cd2780d9e3ed0e62b78a052daa287d466a2fb",
    ),
    (
        Path("data/derived/covalent_small/covapie_bulk_download_admission_unified_dispatch_runtime_with_admit_001_to_005_v1/covapie_admit_001_to_005_runtime_truth_matrix.csv"),
        "1bf3d62d9f6dfe01cdd8850b9bd67dfa30c9d099bde8d4f613a9ecf6989d47b2",
    ),
    (
        Path("data/derived/covalent_small/covapie_bulk_download_admission_unified_dispatch_runtime_with_admit_001_to_005_v1/covapie_admit_001_to_005_registry_routing_and_oracle_audit.csv"),
        "b7302fd4b0776711cec62283a15ade588d1822e68c39ddc7251c7512e0d650ad",
    ),
    (
        Path("data/derived/covalent_small/covapie_bulk_download_admission_unified_dispatch_runtime_with_admit_001_to_005_v1/covapie_admit_001_to_005_runtime_safety_audit.csv"),
        "6f74a0e3c89c8df62ff1547256f64afd291103b6b20b7ed00c04577809eee77b",
    ),
    (
        Path("src/covalent_ext/covapie_bulk_download_admission_admit_006_rule_logic_interface.py"),
        "6fd3727234b4b3f637fa5812c78421ec944238518702bc7f9d0d57a654d9a46d",
    ),
    (
        Path("data/derived/covalent_small/covapie_bulk_download_admission_admit_006_rule_logic_interface_v1/covapie_admit_006_rule_logic_interface_manifest.json"),
        "921356eaa15f40fed925d11d73a6fbb868b4c881828c358fb35fde168b8c33f8",
    ),
    (
        Path("src/covalent_ext/covapie_bulk_download_admission_admit_006_unified_adapter_contract_design_gate.py"),
        "7645a99f107bd784d1868dbab7136803804645874b33a210273944b00447ac89",
    ),
    (
        Path("data/derived/covalent_small/covapie_bulk_download_admission_admit_006_unified_adapter_contract_design_gate_v1/covapie_admit_006_unified_adapter_contract_manifest.json"),
        "449f3f2f5bcf7b7e6a2d60504238da91f41f67822a9747e32fd6eb60b88468b2",
    ),
    (
        Path("data/derived/covalent_small/covapie_bulk_download_admission_admit_006_unified_adapter_contract_design_gate_v1/covapie_admit_006_unified_adapter_contract.csv"),
        "2aee305dc9eece0631a3fe11791b78389639de8f1d573bee185a5046c95ae242",
    ),
    (
        Path("data/derived/covalent_small/covapie_bulk_download_admission_admit_006_unified_adapter_contract_design_gate_v1/covapie_admit_006_candidate_projection_and_context_routing_matrix.csv"),
        "c43b1d1e071607a1040f5d66398164acad5eb01c6873aae32c95bf2796f08fab",
    ),
    (
        Path("data/derived/covalent_small/covapie_bulk_download_admission_admit_006_unified_adapter_contract_design_gate_v1/covapie_admit_006_unified_result_projection_truth_matrix.csv"),
        "c50fa504c6c569127e901f6256fd064b1dc7f773ea92c308279261dcfb9ae7c0",
    ),
    (
        Path("data/derived/covalent_small/covapie_bulk_download_admission_admit_006_unified_adapter_contract_design_gate_v1/covapie_admit_006_unified_adapter_safety_audit.csv"),
        "e34297ac8d8a8e8b841ed1e1ccd0d0783c3f5b755976cfa21a15af3f31797539",
    ),
    (
        Path("data/derived/covalent_small/covapie_bulk_download_admission_admit_006_unified_adapter_contract_design_gate_v1/covapie_admit_006_unified_adapter_issue_readiness_inventory.csv"),
...
CHECKER_CONTRACT_FILENAME = "covapie_admit_001_to_006_runtime_contract.csv"
CHECKER_TRUTH_FILENAME = "covapie_admit_001_to_006_runtime_truth_matrix.csv"
CHECKER_REGISTRY_FILENAME = (
    "covapie_admit_001_to_006_registry_routing_and_oracle_audit.csv"
)
CHECKER_SAFETY_FILENAME = "covapie_admit_001_to_006_runtime_safety_audit.csv"
CHECKER_ISSUE_FILENAME = "covapie_admit_001_to_006_runtime_issue_inventory.csv"
CHECKER_MANIFEST_FILENAME = "covapie_admit_001_to_006_runtime_manifest.json"
CHECKER_CSV_OUTPUTS = (
...
CHECKER_RUNTIME_DEPENDENCY_MODULES = (
    "covalent_ext.covapie_bulk_download_admission_unified_dispatch_runtime_with_admit_001_to_005",
    "covalent_ext.covapie_bulk_download_admission_admit_006_rule_logic_interface",
...
EXPECTED_OUTPUT_SHA256 = {
    "covapie_admit_001_to_006_runtime_contract.csv": "f9fa70076bb7cee1cd4ef6af7ad8bec76d0ef9a95a8d3305da55d96d5a259bcb",
    "covapie_admit_001_to_006_runtime_truth_matrix.csv": "bba064d245f88b274821d52617b7725a22b063d28afdf99d094c5d6dfec348ca",
    "covapie_admit_001_to_006_registry_routing_and_oracle_audit.csv": "beba9b44b65e1459d406506d05e31786174ddec786ffe31586e0d7188ff0f3a6",
    "covapie_admit_001_to_006_runtime_safety_audit.csv": "8b4eec9656a0c34dfc4e9fa480841543f14ab722e7bacfb4e4f1a895d5a7b636",
    "covapie_admit_001_to_006_runtime_issue_inventory.csv": "e63c1b83fe245031ecdefa6b3387086b2aba8d72ef50189be17b9874e8f18196",
    "covapie_admit_001_to_006_runtime_manifest.json": "359c666541602458b3ea6a023be95ea06205f8580ff71d371c25306715f558d6",
}
...
REGISTERED_RULE_IDS = KNOWN_RULE_IDS[:6]
...
def _expected_manifest() -> dict[str, object]:
    ...
    return {
        ...
        "truth_matrix_row_count": 105,
        "truth_matrix_pass_count": 105,
...
def _expected_contract_rows() -> list[dict[str, str]]:
    ...
    definitions = (
        ...
        ("A006_001", "admit006_identity", "rule name", "explicit_covalent_event_evidence"),
        ("A006_002", "admit006_identity", "adapter ID", "covapie_admit_006_unified_adapter_v1"),
...
def _expected_truth_rows() -> list[dict[str, str]]:
    rows = [
        ...
        _truth_row("GLOBAL_STR_SUBCLASS", "global_dispatch", "ADMIT_006", "global_precedence", "UNIFIED_ADMISSION_RULE_ID_TYPE_INVALID", "UNIFIED_ADMISSION_RULE_ID_TYPE_INVALID"),
        ...
        _truth_row("GLOBAL_KNOWN_UNREGISTERED", "global_dispatch", "ADMIT_007", "global_precedence", "UNIFIED_ADMISSION_RULE_NOT_REGISTERED", "UNIFIED_ADMISSION_RULE_NOT_REGISTERED"),
    ...
    for case_id, reason in (
        ("A006_CONTEXT_BATCH", "ADMIT_006_BATCH_CONTEXT_MUST_BE_NONE"),
        ("A006_CONTEXT_EVALUATION", "ADMIT_006_EVALUATION_CONTEXT_MAPPING_REQUIRED"),
        ("A006_CONTEXT_KEY", "ADMIT_006_ALLOWED_COVALENT_EVIDENCE_CLASSES_REQUIRED"),
        ("A006_CONTEXT_DOWNLOAD", "ADMIT_006_DOWNLOAD_RESULT_CONTEXT_MUST_BE_NONE"),
        ("A006_CONTEXT_STAGE", "ADMIT_006_STAGE_AUTHORIZATION_CONTEXT_MUST_BE_NONE"),
        ("A006_CONTEXT_MULTI_PRECEDENCE", "ADMIT_006_BATCH_CONTEXT_MUST_BE_NONE"),
    ):
        rows.append(
            _truth_row(
                case_id,
    ...
    for case_id, value, reason, formal, oracle, access in (
        ("A006_CANDIDATE_NON_MAPPING", "invalid", "ADMIT_006_CANDIDATE_RECORD_MAPPING_INVALID", 0, 0, "envelope_checked"),
        ("A006_CANDIDATE_KEY_MISSING", "invalid", "covalent_event_evidence_missing", 0, 0, "value_read_once"),
        ("A006_CANDIDATE_NONE", "invalid", "covalent_event_evidence_missing", 0, 0, "value_read_once"),
        ("A006_CANDIDATE_EMPTY", "invalid", "covalent_event_evidence_missing", 0, 0, "value_read_once"),
        ("A006_CANDIDATE_EMPTY_SUBCLASS", "invalid", SCALAR_REASONS[0], 1, 1, "value_read_once"),
        ("A006_CANDIDATE_WHITESPACE", "invalid", SCALAR_REASONS[3], 1, 1, "value_read_once"),
        ("A006_CANDIDATE_MALFORMED", "invalid", SCALAR_REASONS[0], 1, 1, "value_read_once"),
        ("A006_CANDIDATE_DISTANCE", "blocked", BLOCKED_REASON, 1, 1, "value_read_once"),
        ("A006_CANDIDATE_MAPPING_SUBCLASS", "passed", "", 1, 1, "value_read_once"),
        ("A006_CANDIDATE_EXTRA_FIELDS", "passed", "", 1, 1, "value_read_once"),
        ("A006_CANDIDATE_NO_MUTATION", "passed", "", 1, 1, "value_read_once"),
        ("A006_CANDIDATE_IDENTITY", "invalid", SCALAR_REASONS[0], 1, 1, "value_read_once"),
    ):
        rows.append(
            _truth_row(
                case_id,
    ...
    for suffix, reason in (
        ("SOURCE_WRONG_TYPE", "ADMIT_006_UNIFIED_ADAPTER_SOURCE_TYPE_INVALID"),
        ("SOURCE_SUBCLASS", "ADMIT_006_UNIFIED_ADAPTER_SOURCE_TYPE_INVALID"),
        ("SOURCE_MISSING_SHAPE", "ADMIT_006_UNIFIED_ADAPTER_SOURCE_INVARIANT_INVALID"),
        ("SOURCE_EXTRA_SHAPE", "ADMIT_006_UNIFIED_ADAPTER_SOURCE_INVARIANT_INVALID"),
        ("SOURCE_RULE_ID", "ADMIT_006_UNIFIED_ADAPTER_SOURCE_INVARIANT_INVALID"),
        ("SOURCE_OUTCOME", "ADMIT_006_UNIFIED_ADAPTER_SOURCE_INVARIANT_INVALID"),
        ("SOURCE_PASSED", "ADMIT_006_UNIFIED_ADAPTER_SOURCE_INVARIANT_INVALID"),
        ("SOURCE_BLOCKS", "ADMIT_006_UNIFIED_ADAPTER_SOURCE_INVARIANT_INVALID"),
        ("SOURCE_REASON", "ADMIT_006_UNIFIED_ADAPTER_SOURCE_INVARIANT_INVALID"),
        ("SOURCE_CANONICAL", "ADMIT_006_UNIFIED_ADAPTER_SOURCE_INVARIANT_INVALID"),
        ("SOURCE_VALIDATED", "ADMIT_006_UNIFIED_ADAPTER_SOURCE_INVARIANT_INVALID"),
        ("SOURCE_CONSUMED_CANDIDATE", "ADMIT_006_UNIFIED_ADAPTER_SOURCE_INVARIANT_INVALID"),
        ("SOURCE_CONSUMED_CONTEXT", "ADMIT_006_UNIFIED_ADAPTER_SOURCE_INVARIANT_INVALID"),
        ("SOURCE_IO", "ADMIT_006_UNIFIED_ADAPTER_SOURCE_INVARIANT_INVALID"),
    ):
        rows.append(
            _truth_row(
                f"A006_{suffix}",
    ...
    for case_id, behavior, value, reason, formal, oracle, access in (
        ...
        ("PROJECTION_NON_MAPPING", "adapter_generated_exact13", "invalid", "ADMIT_006_CANDIDATE_RECORD_MAPPING_INVALID", 0, 0, "envelope_checked"),
    ):
        rows.append(
            _truth_row(
                case_id,
        ...
        rows.append(
            {
                ...
                "predecessor_handler_identity_reused": str(rule_id in KNOWN_RULE_IDS[:5]).lower(),
                "successor_handler_implemented": str(rule_id == "ADMIT_006").lower(),
...
def _check_production_constant_alignment(
    ...
    if hasattr(runtime, "EXACT5_ISSUE_PATH"):
        raise AssertionError("obsolete Exact5 issue alias remains")
    ...
    dependency_modules = (
        ...
        runtime.admit006.__name__,
        runtime.admit006_oracle.__name__,
    )
...
def _check_runtime_directly() -> None:
    ...
    if runtime.EVALUATOR_REGISTRY["ADMIT_006"] is not runtime._evaluate_registered_admit_006:
        raise AssertionError("ADMIT_006 handler not registered")
    ...
    error = _assert_error(
        lambda: runtime.evaluate_admission_rule(Text("ADMIT_006"), {}),
        "UNIFIED_ADMISSION_RULE_ID_TYPE_INVALID",
        "UNIFIED_ADMISSION_RULE_ID_TYPE_INVALID",
    )
    ...
    with (
        patch.object(runtime.admit006, "evaluate_admit_006", lambda *args: counts.update(["formal"])),
        patch.object(runtime.admit006_oracle, "classify_admit_006_admit_007_evidence_design", lambda *args: counts.update(["oracle"])),
    ):
        error = _assert_error(
    ...
    error = _assert_error(
        lambda: runtime.evaluate_admission_rule(
            "ADMIT_006", {}, evaluation_context=missing_context
        ),
        "UNIFIED_ADMISSION_CONTEXT_ROUTING_INVALID",
    ...
    source = runtime.admit006.evaluate_admit_006(ENUM_MEMBERS[0], ALLOWED_CLASSES)
    classification = runtime.admit006_oracle.classify_admit_006_admit_007_evidence_design(
        ENUM_MEMBERS[0], ALLOWED_CLASSES
    )
    calls: dict[str, list[tuple[object, object]]] = {"formal": [], "oracle": []}
    with (
        patch.object(runtime.admit006, "evaluate_admit_006", lambda left, right: calls["formal"].append((left, right)) or source),
        patch.object(runtime.admit006_oracle, "classify_admit_006_admit_007_evidence_design", lambda left, right: calls["oracle"].append((left, right)) or classification),
    ):
        result = runtime.evaluate_admission_rule(
            "ADMIT_006", candidate, evaluation_context=evaluation
        )
    ...
    for candidate_value in ({}, {CANDIDATE_FIELD: None}, {CANDIDATE_FIELD: ""}):
        with (
            patch.object(runtime.admit006, "evaluate_admit_006", side_effect=AssertionError("formal called")),
            patch.object(runtime.admit006_oracle, "classify_admit_006_admit_007_evidence_design", side_effect=AssertionError("oracle called")),
        ):
    ...
    for storage_mode in ("missing", "extra"):
        corrupt = runtime.admit006.evaluate_admit_006(
            ENUM_MEMBERS[0], ALLOWED_CLASSES
        )
        if storage_mode == "missing":
            object.__delattr__(corrupt, runtime.admit006.RESULT_FIELDS[-1])
        else:
        ...
        with (
            ...
            patch.object(
                runtime.admit006_oracle,
                "classify_admit_006_admit_007_evidence_design",
                side_effect=AssertionError("oracle called"),
            ),
            patch.object(
                runtime,
                "_project_admit006_exact13",
    ...
    bad = runtime.admit006.evaluate_admit_006(ENUM_MEMBERS[0], ALLOWED_CLASSES)
    object.__setattr__(bad, "evaluator_io_used", True)
    counts.clear()
    with (
        patch.object(runtime.admit006, "evaluate_admit_006", lambda *args: counts.update(["formal"]) or bad),
        patch.object(runtime.admit006_oracle, "classify_admit_006_admit_007_evidence_design", lambda *args: counts.update(["oracle"])),
    ):
        error = _assert_error(
            lambda: runtime.evaluate_admission_rule(
    ...
    valid = runtime.admit006.evaluate_admit_006(ENUM_MEMBERS[0], ALLOWED_CLASSES)
    mismatch = runtime.admit006_oracle.classify_admit_006_admit_007_evidence_design(
        ENUM_MEMBERS[1], ALLOWED_CLASSES
    )
    counts.clear()
    with (
        patch.object(runtime.admit006, "evaluate_admit_006", lambda *args: counts.update(["formal"]) or valid),
        patch.object(runtime.admit006_oracle, "classify_admit_006_admit_007_evidence_design", lambda *args: counts.update(["oracle"]) or mismatch),
        patch.object(runtime, "_project_admit006_exact13", side_effect=AssertionError("projected")),
    ):
        _assert_error(
            lambda: runtime.evaluate_admission_rule(
                "ADMIT_006",
...
def _check_public_call_graph() -> None:
    path = REPO_ROOT / "src/covalent_ext/covapie_bulk_download_admission_unified_dispatch_runtime_with_admit_001_to_006.py"
    ...
    banned = {
        ...
        "run_covapie_bulk_download_admission_unified_dispatch_runtime_with_admit_001_to_006_v1",
        "_git",
        "open",
        "read",
        "read_bytes",
    ...
    pending = ["evaluate_admission_rule", "_evaluate_registered_admit_006"]
    closure: set[str] = set()
    while pending:
        name = pending.pop()
        if name in closure:
    ...
    required = {
        ...
        "_admit006_candidate_invalid",
        "_prevalidate_admit006_source",
        "_expected_admit006_from_oracle",
        "_validate_admit006_oracle_equivalence",
        "_project_admit006_exact13",
    ...
    if "admit_006_unified_adapter_contract_design_gate" in import_section:
    ...
    standalone_tree = ast.parse(
        (REPO_ROOT / "src/covalent_ext/covapie_bulk_download_admission_admit_006_rule_logic_interface.py").read_text(encoding="utf-8")
    )
    ...
    if "classify_admit_006_admit_007_evidence_design" in _called_names(
        standalone_functions["evaluate_admit_006"]
    ):
...
def _validate_output_root(
    ...
    *,
    ...
    if contract_header != headers[CHECKER_CONTRACT_FILENAME] or contract_rows != _expected_contract_rows():
        raise AssertionError("Exact56 contract semantics mismatch")
    if truth_header != headers[CHECKER_TRUTH_FILENAME] or truth_rows != _expected_truth_rows():
        raise AssertionError("Exact105 truth semantics mismatch")
...
def _check_materialization() -> None:
    with tempfile.TemporaryDirectory(prefix="covapie-exact6-check-") as temporary:
        first_root = Path(temporary) / "first"
        second_root = Path(temporary) / "second"
        runtime.run_covapie_bulk_download_admission_unified_dispatch_runtime_with_admit_001_to_006_v1(first_root)
        runtime.run_covapie_bulk_download_admission_unified_dispatch_runtime_with_admit_001_to_006_v1(second_root)
        for name in _expected_output_filenames():
        ...
        try:
            runtime.run_covapie_bulk_download_admission_unified_dispatch_runtime_with_admit_001_to_006_v1(unsafe_root)
        except ValueError:
            pass
        else:
...
def main() -> int:
    ...
    _silent_import(
        "import covalent_ext.covapie_bulk_download_admission_unified_dispatch_runtime_with_admit_001_to_006"
    )
    checker_path = Path(__file__)
    _silent_import(
        "import importlib.util;"
        f"s=importlib.util.spec_from_file_location('exact6_checker',{str(checker_path)!r});"
        "m=importlib.util.module_from_spec(s);s.loader.exec_module(m)"
    )

    print("all_checks_passed=true")
    print("exact18_source_sha=18/18")
    print("registered_rule_count=6")
    print("predecessor_handler_identity_reused=5/5")
