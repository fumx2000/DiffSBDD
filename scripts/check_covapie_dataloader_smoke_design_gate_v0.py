...
from covalent_ext import covapie_dataloader_smoke_design_gate as legacy  # noqa: E402
...
def run() -> int:
    ...
    print(
        ...
        if passed
        else "covapie_dataloader_smoke_design_gate_v0_retirement_policy_blocked"
    )
