...
from covalent_ext import covapie_metadata_dataloader_smoke as legacy  # noqa: E402
...
def run() -> int:
    ...
    print(
        "covapie_metadata_dataloader_smoke_v0_retirement_policy_passed"
        if passed
        else "covapie_metadata_dataloader_smoke_v0_retirement_policy_blocked"
    )
